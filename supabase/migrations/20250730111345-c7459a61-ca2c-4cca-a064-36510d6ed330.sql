-- Fix critical security issues identified by the linter (corrected)

-- 1. Enable RLS on tables that don't have it (excluding views)
...
-- 3. Fix remaining functions with search_path
