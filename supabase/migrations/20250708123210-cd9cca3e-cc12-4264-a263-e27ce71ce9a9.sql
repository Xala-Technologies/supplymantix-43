-- Add recurrence support to work orders
ALTER TABLE public.work_orders 
ADD COLUMN recurrence_rule TEXT DEFAULT 'none',
...
ADD COLUMN parent_recurrence_id UUID REFERENCES public.work_orders(id);
