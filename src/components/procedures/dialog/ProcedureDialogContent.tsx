...
export const ProcedureDialogContent: React.FC<ProcedureDialogContentProps> = ({
  ...
  return (
    <Tabs defaultValue={isEditing ? "settings" : "fields"} className="flex-1 flex flex-col min-h-0 mt-4">
      ...
      <div className="flex-1 min-h-0">
        <TabsContent value="fields" className="h-full overflow-y-auto space-y-3 mt-0 pr-2">
          <ProcedureFieldsTab
            procedure={procedure}
            isEditing={isEditing}
            editData={editData}
        ...
        <TabsContent value="settings" className="h-full overflow-y-auto mt-0 pr-2">
