  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 h-16 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="flex-1 max-w-lg mx-8 ml-12">
        ...
        <div className="flex items-center space-x-3 min-w-0">
          ...
          {/* Notifications */}
          <Button variant="ghost" size="sm" className="relative h-9 w-9 p-0 shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center space-x-3 h-auto px-3 py-2 min-w-0">
