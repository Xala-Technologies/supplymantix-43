    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-[95vw] w-[95vw] h-[95vh] p-0 overflow-hidden">
        <div className="h-full flex flex-col">
          {/* Compact Header */}
          <DialogHeader className="p-3 border-b bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
            <DialogTitle className="text-lg font-semibold">New Work Order</DialogTitle>
          </DialogHeader>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="md:col-span-2">
                        ...
                        <FormControl>
                          <Input placeholder="Enter work order title" {...field} className="h-9" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                          ...
                          {showCalendar && (
                            <div className="absolute top-full left-0 z-50 mt-1">
                              <Calendar
                                ...
                                className="rounded-md border bg-white shadow-lg pointer-events-auto"
                              />
                            </div>
                          )}
                        </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">Asset</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger className="h-9">
